...
const PAIN_POINTS: PainCard[] = [
  {
    ...
    moneyStat: { prefix: '£', value: 98000, suffix: '/yr' },
    moneyLabel: 'average revenue lost from missed calls per year (UK SME estimate)',
  ...
  },
  {
    ...
    moneyStat: { prefix: '£', value: 60000, suffix: '/yr' },
    moneyLabel: 'in annual revenue lost from slow follow-up, on exactly the same lead volume (UK SME estimate)',
