...
const IndustrySection = ({
  icon: Icon, slug, name, image, pain, fix, metrics, i, surface,
    ...
    <Section surface={surface}>
      <div className="grid items-start gap-10 lg:grid-cols-2">
        ...
        <Reveal delay={100}>
          ...
          <p className={`mt-4 font-body text-base leading-relaxed ${textMuted}`}>
            <strong className="font-medium">An example of a common bottleneck in this field:</strong> {pain}
          </p>
